<?php
    include("../../views/modal/administracion/agregar_detalle_factuta.php");
...
<div class="details">
  <div class="recentOrders">
    <div class="cardHeader">
      <h2>Listado Detalle de Factura</h2>
      <h6>Deseas Exportar</h6> 
      <a href="#" class="btn" data-bs-toggle="modal" data-bs-target="#nuevoModal"><span class="material-symbols-outlined">add</span>Nuevo Detalle de Factura</a>
    </div>
