...
if ($_POST['contrasena'] != $_POST['confcontasena']) {
  echo '<script>alert("La contraseña no coincide"); window.location.href = "registro.php";</script>';
} else {
  ...
  if ($num_rows > 0) {
    echo '<script>alert("El email y el usuario ya existen en la base de datos"); window.location.href = "registro.php";</script>';
  } else {
    ...
    if ($ejecutas) {
      ...
      echo '<script>alert("Error al insertar en la base de datos"); window.location.href = "registro.php";</script>';
    }
  }
}
